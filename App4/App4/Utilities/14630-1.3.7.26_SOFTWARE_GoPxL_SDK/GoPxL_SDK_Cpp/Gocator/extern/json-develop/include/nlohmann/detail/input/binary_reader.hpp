  ...
  private:
    ...
    */
                    ...
                    binary_t& result)
    {
        ...
        // Updated to increase performance serializing fomr msgpack to json binary.
        // Note: This should be updated if nlohmann json gets updated.
        // binary_reader::get_binary() method optimizations:
        // 1) Resized result before for() loop, 
        // 2) changed push_back() to [] assignment, 
        // 3) and replaced unexpect_eof() call to comparison to eof() directly.
        bool success = true;
