...
ifeq ($(config),Debug)
	...
	OBJECTS := ../../../../build/ReceiveAsync-gnumk_linux_x64-Debug/ReceiveAsync.cpp.o \
	../../../../build/ReceiveAsync-gnumk_linux_x64-Debug/SampleUtils.cpp.o
	DEP_FILES = ../../../../build/ReceiveAsync-gnumk_linux_x64-Debug/ReceiveAsync.cpp.d \
	../../../../build/ReceiveAsync-gnumk_linux_x64-Debug/SampleUtils.cpp.d
...
ifeq ($(config),Release)
	...
	OBJECTS := ../../../../build/ReceiveAsync-gnumk_linux_x64-Release/ReceiveAsync.cpp.o \
	../../../../build/ReceiveAsync-gnumk_linux_x64-Release/SampleUtils.cpp.o
	DEP_FILES = ../../../../build/ReceiveAsync-gnumk_linux_x64-Release/ReceiveAsync.cpp.d \
	../../../../build/ReceiveAsync-gnumk_linux_x64-Release/SampleUtils.cpp.d
...
$(OBJ_DIR): ReceiveAsync-Linux_X64.mk
...
ifeq ($(MAKECMDGOALS),)
ifeq ($(MAKE_RESTARTS),)
ReceiveAsync-Linux_X64.mk: ReceiveAsync.xml ../../../GoPxLSdk.xml ../../../../Platform/scripts/Utils/Generator/GnuMk.py ../../GoPxLSdk.xml 
	$(info RegenX64 ReceiveAsync-Linux_X64.mk)
	$(SILENT) $(KGENERATOR) --writers=GnuMk_Linux_X64 --platforms=Linux_X64 --project=ReceiveAsync ../../../GoPxLSdk.xml
endif
endif
endif
...
../../../../build/ReceiveAsync-gnumk_linux_x64-Debug/ReceiveAsync.cpp.o ../../../../build/ReceiveAsync-gnumk_linux_x64-Debug/ReceiveAsync.cpp.d: src/ReceiveAsync.cpp
	$(SILENT) $(info GccX64 src/ReceiveAsync.cpp)
	$(SILENT) $(GNU_CXX_COMPILER) $(GNU_COMPILER_FLAGS) $(CXX_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../../build/ReceiveAsync-gnumk_linux_x64-Debug/ReceiveAsync.cpp.o -c src/ReceiveAsync.cpp -MMD -MP

../../../../build/ReceiveAsync-gnumk_linux_x64-Debug/SampleUtils.cpp.o ../../../../build/ReceiveAsync-gnumk_linux_x64-Debug/SampleUtils.cpp.d: ../Common/src/SampleUtils.cpp
	$(SILENT) $(info GccX64 ../Common/src/SampleUtils.cpp)
	$(SILENT) $(GNU_CXX_COMPILER) $(GNU_COMPILER_FLAGS) $(CXX_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../../build/ReceiveAsync-gnumk_linux_x64-Debug/SampleUtils.cpp.o -c ../Common/src/SampleUtils.cpp -MMD -MP

endif

ifeq ($(config),Release)

../../../../build/ReceiveAsync-gnumk_linux_x64-Release/ReceiveAsync.cpp.o ../../../../build/ReceiveAsync-gnumk_linux_x64-Release/ReceiveAsync.cpp.d: src/ReceiveAsync.cpp
	$(SILENT) $(info GccX64 src/ReceiveAsync.cpp)
	$(SILENT) $(GNU_CXX_COMPILER) $(GNU_COMPILER_FLAGS) $(CXX_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../../build/ReceiveAsync-gnumk_linux_x64-Release/ReceiveAsync.cpp.o -c src/ReceiveAsync.cpp -MMD -MP

../../../../build/ReceiveAsync-gnumk_linux_x64-Release/SampleUtils.cpp.o ../../../../build/ReceiveAsync-gnumk_linux_x64-Release/SampleUtils.cpp.d: ../Common/src/SampleUtils.cpp
	$(SILENT) $(info GccX64 ../Common/src/SampleUtils.cpp)
	$(SILENT) $(GNU_CXX_COMPILER) $(GNU_COMPILER_FLAGS) $(CXX_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../../build/ReceiveAsync-gnumk_linux_x64-Release/SampleUtils.cpp.o -c ../Common/src/SampleUtils.cpp -MMD -MP
...
include ../../../../build/ReceiveAsync-gnumk_linux_x64-Debug/ReceiveAsync.cpp.d
include ../../../../build/ReceiveAsync-gnumk_linux_x64-Debug/SampleUtils.cpp.d

endif

ifeq ($(config),Release)

include ../../../../build/ReceiveAsync-gnumk_linux_x64-Release/ReceiveAsync.cpp.d
include ../../../../build/ReceiveAsync-gnumk_linux_x64-Release/SampleUtils.cpp.d
