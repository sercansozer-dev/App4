...
ifeq ($(config),Debug)
	...
	strip := 0
	wstack := 0
	TARGET := ../../../../bin/linux_x64d/ReceiveImage
	INTERMEDIATES := 
	OBJ_DIR := ../../../../build/ReceiveImage-gnumk_linux_x64-Debug
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../../build/ReceiveImage-gnumk_linux_x64-Debug/ReceiveImage.cpp.o \
	../../../../build/ReceiveImage-gnumk_linux_x64-Debug/SampleUtils.cpp.o
	DEP_FILES = ../../../../build/ReceiveImage-gnumk_linux_x64-Debug/ReceiveImage.cpp.d \
	../../../../build/ReceiveImage-gnumk_linux_x64-Debug/SampleUtils.cpp.d
...
ifeq ($(config),Release)
	...
	strip := 1
	wstack := 0
	TARGET := ../../../../bin/linux_x64/ReceiveImage
	INTERMEDIATES := 
	OBJ_DIR := ../../../../build/ReceiveImage-gnumk_linux_x64-Release
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../../build/ReceiveImage-gnumk_linux_x64-Release/ReceiveImage.cpp.o \
	../../../../build/ReceiveImage-gnumk_linux_x64-Release/SampleUtils.cpp.o
	DEP_FILES = ../../../../build/ReceiveImage-gnumk_linux_x64-Release/ReceiveImage.cpp.d \
	../../../../build/ReceiveImage-gnumk_linux_x64-Release/SampleUtils.cpp.d
...
all: $(OBJ_DIR)
	$(PREBUILD)
	$(SILENT) $(MAKE) -f ReceiveImage-Linux_X64.mk all-dep
	$(SILENT) $(MAKE) -f ReceiveImage-Linux_X64.mk all-obj
...
$(OBJ_DIR): ReceiveImage-Linux_X64.mk
...
ifeq ($(MAKECMDGOALS),)
ifeq ($(MAKE_RESTARTS),)
ReceiveImage-Linux_X64.mk: ReceiveImage.xml ../../../GoPxLSdk.xml ../../../../Platform/scripts/Utils/Generator/GnuMk.py ../../GoPxLSdk.xml 
	$(info RegenX64 ReceiveImage-Linux_X64.mk)
	$(SILENT) $(KGENERATOR) --writers=GnuMk_Linux_X64 --platforms=Linux_X64 --project=ReceiveImage ../../../GoPxLSdk.xml
endif
endif
endif
...
../../../../build/ReceiveImage-gnumk_linux_x64-Debug/ReceiveImage.cpp.o ../../../../build/ReceiveImage-gnumk_linux_x64-Debug/ReceiveImage.cpp.d: src/ReceiveImage.cpp
	$(SILENT) $(info GccX64 src/ReceiveImage.cpp)
	$(SILENT) $(GNU_CXX_COMPILER) $(GNU_COMPILER_FLAGS) $(CXX_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../../build/ReceiveImage-gnumk_linux_x64-Debug/ReceiveImage.cpp.o -c src/ReceiveImage.cpp -MMD -MP

../../../../build/ReceiveImage-gnumk_linux_x64-Debug/SampleUtils.cpp.o ../../../../build/ReceiveImage-gnumk_linux_x64-Debug/SampleUtils.cpp.d: ../Common/src/SampleUtils.cpp
	$(SILENT) $(info GccX64 ../Common/src/SampleUtils.cpp)
	$(SILENT) $(GNU_CXX_COMPILER) $(GNU_COMPILER_FLAGS) $(CXX_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../../build/ReceiveImage-gnumk_linux_x64-Debug/SampleUtils.cpp.o -c ../Common/src/SampleUtils.cpp -MMD -MP

endif

ifeq ($(config),Release)

../../../../build/ReceiveImage-gnumk_linux_x64-Release/ReceiveImage.cpp.o ../../../../build/ReceiveImage-gnumk_linux_x64-Release/ReceiveImage.cpp.d: src/ReceiveImage.cpp
	$(SILENT) $(info GccX64 src/ReceiveImage.cpp)
	$(SILENT) $(GNU_CXX_COMPILER) $(GNU_COMPILER_FLAGS) $(CXX_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../../build/ReceiveImage-gnumk_linux_x64-Release/ReceiveImage.cpp.o -c src/ReceiveImage.cpp -MMD -MP

../../../../build/ReceiveImage-gnumk_linux_x64-Release/SampleUtils.cpp.o ../../../../build/ReceiveImage-gnumk_linux_x64-Release/SampleUtils.cpp.d: ../Common/src/SampleUtils.cpp
	$(SILENT) $(info GccX64 ../Common/src/SampleUtils.cpp)
	$(SILENT) $(GNU_CXX_COMPILER) $(GNU_COMPILER_FLAGS) $(CXX_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../../build/ReceiveImage-gnumk_linux_x64-Release/SampleUtils.cpp.o -c ../Common/src/SampleUtils.cpp -MMD -MP
...
include ../../../../build/ReceiveImage-gnumk_linux_x64-Debug/ReceiveImage.cpp.d
include ../../../../build/ReceiveImage-gnumk_linux_x64-Debug/SampleUtils.cpp.d

endif

ifeq ($(config),Release)

include ../../../../build/ReceiveImage-gnumk_linux_x64-Release/ReceiveImage.cpp.d
include ../../../../build/ReceiveImage-gnumk_linux_x64-Release/SampleUtils.cpp.d
