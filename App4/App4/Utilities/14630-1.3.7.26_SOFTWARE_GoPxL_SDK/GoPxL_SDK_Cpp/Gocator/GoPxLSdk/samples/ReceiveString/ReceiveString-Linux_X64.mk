...
ifeq ($(config),Debug)
	...
	strip := 0
	wstack := 0
	TARGET := ../../../../bin/linux_x64d/ReceiveString
	INTERMEDIATES := 
	OBJ_DIR := ../../../../build/ReceiveString-gnumk_linux_x64-Debug
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../../build/ReceiveString-gnumk_linux_x64-Debug/ReceiveString.cpp.o \
	../../../../build/ReceiveString-gnumk_linux_x64-Debug/SampleUtils.cpp.o
	DEP_FILES = ../../../../build/ReceiveString-gnumk_linux_x64-Debug/ReceiveString.cpp.d \
	../../../../build/ReceiveString-gnumk_linux_x64-Debug/SampleUtils.cpp.d
...
ifeq ($(config),Release)
	...
	strip := 1
	wstack := 0
	TARGET := ../../../../bin/linux_x64/ReceiveString
	INTERMEDIATES := 
	OBJ_DIR := ../../../../build/ReceiveString-gnumk_linux_x64-Release
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../../build/ReceiveString-gnumk_linux_x64-Release/ReceiveString.cpp.o \
	../../../../build/ReceiveString-gnumk_linux_x64-Release/SampleUtils.cpp.o
	DEP_FILES = ../../../../build/ReceiveString-gnumk_linux_x64-Release/ReceiveString.cpp.d \
	../../../../build/ReceiveString-gnumk_linux_x64-Release/SampleUtils.cpp.d
...
all: $(OBJ_DIR)
	$(PREBUILD)
	$(SILENT) $(MAKE) -f ReceiveString-Linux_X64.mk all-dep
	$(SILENT) $(MAKE) -f ReceiveString-Linux_X64.mk all-obj
...
$(OBJ_DIR): ReceiveString-Linux_X64.mk
...
ifeq ($(MAKECMDGOALS),)
ifeq ($(MAKE_RESTARTS),)
ReceiveString-Linux_X64.mk: ReceiveString.xml ../../../GoPxLSdk.xml ../../../../Platform/scripts/Utils/Generator/GnuMk.py ../../GoPxLSdk.xml 
	$(info RegenX64 ReceiveString-Linux_X64.mk)
	$(SILENT) $(KGENERATOR) --writers=GnuMk_Linux_X64 --platforms=Linux_X64 --project=ReceiveString ../../../GoPxLSdk.xml
endif
endif
endif
...
../../../../build/ReceiveString-gnumk_linux_x64-Debug/ReceiveString.cpp.o ../../../../build/ReceiveString-gnumk_linux_x64-Debug/ReceiveString.cpp.d: src/ReceiveString.cpp
	$(SILENT) $(info GccX64 src/ReceiveString.cpp)
	$(SILENT) $(GNU_CXX_COMPILER) $(GNU_COMPILER_FLAGS) $(CXX_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../../build/ReceiveString-gnumk_linux_x64-Debug/ReceiveString.cpp.o -c src/ReceiveString.cpp -MMD -MP

../../../../build/ReceiveString-gnumk_linux_x64-Debug/SampleUtils.cpp.o ../../../../build/ReceiveString-gnumk_linux_x64-Debug/SampleUtils.cpp.d: ../Common/src/SampleUtils.cpp
	$(SILENT) $(info GccX64 ../Common/src/SampleUtils.cpp)
	$(SILENT) $(GNU_CXX_COMPILER) $(GNU_COMPILER_FLAGS) $(CXX_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../../build/ReceiveString-gnumk_linux_x64-Debug/SampleUtils.cpp.o -c ../Common/src/SampleUtils.cpp -MMD -MP

endif

ifeq ($(config),Release)

../../../../build/ReceiveString-gnumk_linux_x64-Release/ReceiveString.cpp.o ../../../../build/ReceiveString-gnumk_linux_x64-Release/ReceiveString.cpp.d: src/ReceiveString.cpp
	$(SILENT) $(info GccX64 src/ReceiveString.cpp)
	$(SILENT) $(GNU_CXX_COMPILER) $(GNU_COMPILER_FLAGS) $(CXX_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../../build/ReceiveString-gnumk_linux_x64-Release/ReceiveString.cpp.o -c src/ReceiveString.cpp -MMD -MP

../../../../build/ReceiveString-gnumk_linux_x64-Release/SampleUtils.cpp.o ../../../../build/ReceiveString-gnumk_linux_x64-Release/SampleUtils.cpp.d: ../Common/src/SampleUtils.cpp
	$(SILENT) $(info GccX64 ../Common/src/SampleUtils.cpp)
	$(SILENT) $(GNU_CXX_COMPILER) $(GNU_COMPILER_FLAGS) $(CXX_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../../build/ReceiveString-gnumk_linux_x64-Release/SampleUtils.cpp.o -c ../Common/src/SampleUtils.cpp -MMD -MP
...
include ../../../../build/ReceiveString-gnumk_linux_x64-Debug/ReceiveString.cpp.d
include ../../../../build/ReceiveString-gnumk_linux_x64-Debug/SampleUtils.cpp.d

endif

ifeq ($(config),Release)

include ../../../../build/ReceiveString-gnumk_linux_x64-Release/ReceiveString.cpp.d
include ../../../../build/ReceiveString-gnumk_linux_x64-Release/SampleUtils.cpp.d
