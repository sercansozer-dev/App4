...
ifeq ($(config),Debug)
	...
	strip := 0
	wstack := 0
	TARGET := ../../../../bin/linux_x64d/ConfigureTool
	INTERMEDIATES := 
	OBJ_DIR := ../../../../build/ConfigureTool-gnumk_linux_x64-Debug
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../../build/ConfigureTool-gnumk_linux_x64-Debug/ConfigureTool.cpp.o \
	../../../../build/ConfigureTool-gnumk_linux_x64-Debug/SampleUtils.cpp.o
	DEP_FILES = ../../../../build/ConfigureTool-gnumk_linux_x64-Debug/ConfigureTool.cpp.d \
	../../../../build/ConfigureTool-gnumk_linux_x64-Debug/SampleUtils.cpp.d
...
ifeq ($(config),Release)
	...
	strip := 1
	wstack := 0
	TARGET := ../../../../bin/linux_x64/ConfigureTool
	INTERMEDIATES := 
	OBJ_DIR := ../../../../build/ConfigureTool-gnumk_linux_x64-Release
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../../build/ConfigureTool-gnumk_linux_x64-Release/ConfigureTool.cpp.o \
	../../../../build/ConfigureTool-gnumk_linux_x64-Release/SampleUtils.cpp.o
	DEP_FILES = ../../../../build/ConfigureTool-gnumk_linux_x64-Release/ConfigureTool.cpp.d \
	../../../../build/ConfigureTool-gnumk_linux_x64-Release/SampleUtils.cpp.d
...
all: $(OBJ_DIR)
	$(PREBUILD)
	$(SILENT) $(MAKE) -f ConfigureTool-Linux_X64.mk all-dep
	$(SILENT) $(MAKE) -f ConfigureTool-Linux_X64.mk all-obj
...
$(OBJ_DIR): ConfigureTool-Linux_X64.mk
...
ifeq ($(MAKECMDGOALS),)
ifeq ($(MAKE_RESTARTS),)
ConfigureTool-Linux_X64.mk: ConfigureTool.xml ../../../GoPxLSdk.xml ../../../../Platform/scripts/Utils/Generator/GnuMk.py ../../GoPxLSdk.xml 
	$(info RegenX64 ConfigureTool-Linux_X64.mk)
	$(SILENT) $(KGENERATOR) --writers=GnuMk_Linux_X64 --platforms=Linux_X64 --project=ConfigureTool ../../../GoPxLSdk.xml
endif
endif
endif
...
../../../../build/ConfigureTool-gnumk_linux_x64-Debug/ConfigureTool.cpp.o ../../../../build/ConfigureTool-gnumk_linux_x64-Debug/ConfigureTool.cpp.d: src/ConfigureTool.cpp
	$(SILENT) $(info GccX64 src/ConfigureTool.cpp)
	$(SILENT) $(GNU_CXX_COMPILER) $(GNU_COMPILER_FLAGS) $(CXX_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../../build/ConfigureTool-gnumk_linux_x64-Debug/ConfigureTool.cpp.o -c src/ConfigureTool.cpp -MMD -MP

../../../../build/ConfigureTool-gnumk_linux_x64-Debug/SampleUtils.cpp.o ../../../../build/ConfigureTool-gnumk_linux_x64-Debug/SampleUtils.cpp.d: ../Common/src/SampleUtils.cpp
	$(SILENT) $(info GccX64 ../Common/src/SampleUtils.cpp)
	$(SILENT) $(GNU_CXX_COMPILER) $(GNU_COMPILER_FLAGS) $(CXX_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../../build/ConfigureTool-gnumk_linux_x64-Debug/SampleUtils.cpp.o -c ../Common/src/SampleUtils.cpp -MMD -MP

endif

ifeq ($(config),Release)

../../../../build/ConfigureTool-gnumk_linux_x64-Release/ConfigureTool.cpp.o ../../../../build/ConfigureTool-gnumk_linux_x64-Release/ConfigureTool.cpp.d: src/ConfigureTool.cpp
	$(SILENT) $(info GccX64 src/ConfigureTool.cpp)
	$(SILENT) $(GNU_CXX_COMPILER) $(GNU_COMPILER_FLAGS) $(CXX_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../../build/ConfigureTool-gnumk_linux_x64-Release/ConfigureTool.cpp.o -c src/ConfigureTool.cpp -MMD -MP

../../../../build/ConfigureTool-gnumk_linux_x64-Release/SampleUtils.cpp.o ../../../../build/ConfigureTool-gnumk_linux_x64-Release/SampleUtils.cpp.d: ../Common/src/SampleUtils.cpp
	$(SILENT) $(info GccX64 ../Common/src/SampleUtils.cpp)
	$(SILENT) $(GNU_CXX_COMPILER) $(GNU_COMPILER_FLAGS) $(CXX_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../../build/ConfigureTool-gnumk_linux_x64-Release/SampleUtils.cpp.o -c ../Common/src/SampleUtils.cpp -MMD -MP
...
include ../../../../build/ConfigureTool-gnumk_linux_x64-Debug/ConfigureTool.cpp.d
include ../../../../build/ConfigureTool-gnumk_linux_x64-Debug/SampleUtils.cpp.d

endif

ifeq ($(config),Release)

include ../../../../build/ConfigureTool-gnumk_linux_x64-Release/ConfigureTool.cpp.d
include ../../../../build/ConfigureTool-gnumk_linux_x64-Release/SampleUtils.cpp.d
