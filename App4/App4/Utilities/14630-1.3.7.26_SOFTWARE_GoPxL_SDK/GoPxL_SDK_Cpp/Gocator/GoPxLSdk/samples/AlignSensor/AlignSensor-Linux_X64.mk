...
ifeq ($(config),Debug)
	...
	strip := 0
	wstack := 0
	TARGET := ../../../../bin/linux_x64d/AlignSensor
	INTERMEDIATES := 
	OBJ_DIR := ../../../../build/AlignSensor-gnumk_linux_x64-Debug
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../../build/AlignSensor-gnumk_linux_x64-Debug/AlignSensor.cpp.o \
	../../../../build/AlignSensor-gnumk_linux_x64-Debug/SampleUtils.cpp.o
	DEP_FILES = ../../../../build/AlignSensor-gnumk_linux_x64-Debug/AlignSensor.cpp.d \
	../../../../build/AlignSensor-gnumk_linux_x64-Debug/SampleUtils.cpp.d
...
ifeq ($(config),Release)
	...
	strip := 1
	wstack := 0
	TARGET := ../../../../bin/linux_x64/AlignSensor
	INTERMEDIATES := 
	OBJ_DIR := ../../../../build/AlignSensor-gnumk_linux_x64-Release
	PREBUILD := 
	POSTBUILD := 
	...
	OBJECTS := ../../../../build/AlignSensor-gnumk_linux_x64-Release/AlignSensor.cpp.o \
	../../../../build/AlignSensor-gnumk_linux_x64-Release/SampleUtils.cpp.o
	DEP_FILES = ../../../../build/AlignSensor-gnumk_linux_x64-Release/AlignSensor.cpp.d \
	../../../../build/AlignSensor-gnumk_linux_x64-Release/SampleUtils.cpp.d
...
all: $(OBJ_DIR)
	$(PREBUILD)
	$(SILENT) $(MAKE) -f AlignSensor-Linux_X64.mk all-dep
	$(SILENT) $(MAKE) -f AlignSensor-Linux_X64.mk all-obj
...
$(OBJ_DIR): AlignSensor-Linux_X64.mk
...
ifeq ($(MAKECMDGOALS),)
ifeq ($(MAKE_RESTARTS),)
AlignSensor-Linux_X64.mk: AlignSensor.xml ../../../GoPxLSdk.xml ../../../../Platform/scripts/Utils/Generator/GnuMk.py ../../GoPxLSdk.xml 
	$(info RegenX64 AlignSensor-Linux_X64.mk)
	$(SILENT) $(KGENERATOR) --writers=GnuMk_Linux_X64 --platforms=Linux_X64 --project=AlignSensor ../../../GoPxLSdk.xml
endif
endif
endif
...
../../../../build/AlignSensor-gnumk_linux_x64-Debug/AlignSensor.cpp.o ../../../../build/AlignSensor-gnumk_linux_x64-Debug/AlignSensor.cpp.d: src/AlignSensor.cpp
	$(SILENT) $(info GccX64 src/AlignSensor.cpp)
	$(SILENT) $(GNU_CXX_COMPILER) $(GNU_COMPILER_FLAGS) $(CXX_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../../build/AlignSensor-gnumk_linux_x64-Debug/AlignSensor.cpp.o -c src/AlignSensor.cpp -MMD -MP

../../../../build/AlignSensor-gnumk_linux_x64-Debug/SampleUtils.cpp.o ../../../../build/AlignSensor-gnumk_linux_x64-Debug/SampleUtils.cpp.d: ../Common/src/SampleUtils.cpp
	$(SILENT) $(info GccX64 ../Common/src/SampleUtils.cpp)
	$(SILENT) $(GNU_CXX_COMPILER) $(GNU_COMPILER_FLAGS) $(CXX_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../../build/AlignSensor-gnumk_linux_x64-Debug/SampleUtils.cpp.o -c ../Common/src/SampleUtils.cpp -MMD -MP

endif

ifeq ($(config),Release)

../../../../build/AlignSensor-gnumk_linux_x64-Release/AlignSensor.cpp.o ../../../../build/AlignSensor-gnumk_linux_x64-Release/AlignSensor.cpp.d: src/AlignSensor.cpp
	$(SILENT) $(info GccX64 src/AlignSensor.cpp)
	$(SILENT) $(GNU_CXX_COMPILER) $(GNU_COMPILER_FLAGS) $(CXX_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../../build/AlignSensor-gnumk_linux_x64-Release/AlignSensor.cpp.o -c src/AlignSensor.cpp -MMD -MP

../../../../build/AlignSensor-gnumk_linux_x64-Release/SampleUtils.cpp.o ../../../../build/AlignSensor-gnumk_linux_x64-Release/SampleUtils.cpp.d: ../Common/src/SampleUtils.cpp
	$(SILENT) $(info GccX64 ../Common/src/SampleUtils.cpp)
	$(SILENT) $(GNU_CXX_COMPILER) $(GNU_COMPILER_FLAGS) $(CXX_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../../build/AlignSensor-gnumk_linux_x64-Release/SampleUtils.cpp.o -c ../Common/src/SampleUtils.cpp -MMD -MP
...
include ../../../../build/AlignSensor-gnumk_linux_x64-Debug/AlignSensor.cpp.d
include ../../../../build/AlignSensor-gnumk_linux_x64-Debug/SampleUtils.cpp.d

endif

ifeq ($(config),Release)

include ../../../../build/AlignSensor-gnumk_linux_x64-Release/AlignSensor.cpp.d
include ../../../../build/AlignSensor-gnumk_linux_x64-Release/SampleUtils.cpp.d
