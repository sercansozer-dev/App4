...
ifeq ($(config),Debug)
	...
	OBJECTS := ../../../../build/Discover-gnumk_linux_x64-Debug/Discover.cpp.o \
	../../../../build/Discover-gnumk_linux_x64-Debug/SampleUtils.cpp.o
	DEP_FILES = ../../../../build/Discover-gnumk_linux_x64-Debug/Discover.cpp.d \
	../../../../build/Discover-gnumk_linux_x64-Debug/SampleUtils.cpp.d
...
ifeq ($(config),Release)
	...
	OBJECTS := ../../../../build/Discover-gnumk_linux_x64-Release/Discover.cpp.o \
	../../../../build/Discover-gnumk_linux_x64-Release/SampleUtils.cpp.o
	DEP_FILES = ../../../../build/Discover-gnumk_linux_x64-Release/Discover.cpp.d \
	../../../../build/Discover-gnumk_linux_x64-Release/SampleUtils.cpp.d
...
ifeq ($(MAKECMDGOALS),)
ifeq ($(MAKE_RESTARTS),)
Discover-Linux_X64.mk: Discover.xml ../../../GoPxLSdk.xml ../../../../Platform/scripts/Utils/Generator/GnuMk.py ../../GoPxLSdk.xml 
	$(info RegenX64 Discover-Linux_X64.mk)
	$(SILENT) $(KGENERATOR) --writers=GnuMk_Linux_X64 --platforms=Linux_X64 --project=Discover ../../../GoPxLSdk.xml
endif
endif
endif
...
../../../../build/Discover-gnumk_linux_x64-Debug/Discover.cpp.o ../../../../build/Discover-gnumk_linux_x64-Debug/Discover.cpp.d: src/Discover.cpp
	$(SILENT) $(info GccX64 src/Discover.cpp)
	$(SILENT) $(GNU_CXX_COMPILER) $(GNU_COMPILER_FLAGS) $(CXX_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../../build/Discover-gnumk_linux_x64-Debug/Discover.cpp.o -c src/Discover.cpp -MMD -MP

../../../../build/Discover-gnumk_linux_x64-Debug/SampleUtils.cpp.o ../../../../build/Discover-gnumk_linux_x64-Debug/SampleUtils.cpp.d: ../Common/src/SampleUtils.cpp
	$(SILENT) $(info GccX64 ../Common/src/SampleUtils.cpp)
	$(SILENT) $(GNU_CXX_COMPILER) $(GNU_COMPILER_FLAGS) $(CXX_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../../build/Discover-gnumk_linux_x64-Debug/SampleUtils.cpp.o -c ../Common/src/SampleUtils.cpp -MMD -MP

endif

ifeq ($(config),Release)

../../../../build/Discover-gnumk_linux_x64-Release/Discover.cpp.o ../../../../build/Discover-gnumk_linux_x64-Release/Discover.cpp.d: src/Discover.cpp
	$(SILENT) $(info GccX64 src/Discover.cpp)
	$(SILENT) $(GNU_CXX_COMPILER) $(GNU_COMPILER_FLAGS) $(CXX_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../../build/Discover-gnumk_linux_x64-Release/Discover.cpp.o -c src/Discover.cpp -MMD -MP

../../../../build/Discover-gnumk_linux_x64-Release/SampleUtils.cpp.o ../../../../build/Discover-gnumk_linux_x64-Release/SampleUtils.cpp.d: ../Common/src/SampleUtils.cpp
	$(SILENT) $(info GccX64 ../Common/src/SampleUtils.cpp)
	$(SILENT) $(GNU_CXX_COMPILER) $(GNU_COMPILER_FLAGS) $(CXX_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../../../build/Discover-gnumk_linux_x64-Release/SampleUtils.cpp.o -c ../Common/src/SampleUtils.cpp -MMD -MP
...
include ../../../../build/Discover-gnumk_linux_x64-Debug/Discover.cpp.d
include ../../../../build/Discover-gnumk_linux_x64-Debug/SampleUtils.cpp.d

endif

ifeq ($(config),Release)

include ../../../../build/Discover-gnumk_linux_x64-Release/Discover.cpp.d
include ../../../../build/Discover-gnumk_linux_x64-Release/SampleUtils.cpp.d
