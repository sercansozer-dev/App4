...
namespace Lmi3d
{
    namespace Zen
    {
        ...
        public value struct KStatus
        {
            ...
            /// <summary>System not fully functional due to overheat error.</summary>
            literal k32s ErrorOverheat = kERROR_OVERHEAT;
       ...
       /// <summary>Represents the byte-ordering of primative data types.</summary>       
        ...
        namespace Data
        {
            ...
            public value struct KPixelFormat
            {
                ...
                /// <summary>Monochrome, 12 bits packed   (GEV:  Mono12Packed).</summary>
                literal k32s FormatMono12Packed = kPIXEL_FORMAT_MONO12_PACKED;
            };
            ...
            /// <summary>Window structure with 32-bit unsigned integer fields. </summary>
            [StructLayout(LayoutKind::Explicit, Size = sizeof(kWindow32u))]
                public value struct KWindow32u
            {
                KDeclareStruct(KWindow32u, kWindow32u)

                    /// <summary>Initializes a new KWindow32u instance.</summary>
                    KWindow32u(k32u left, k32u top, k32u width, k32u height)
                    : Left(left), Top(top), Width(width), Height(height)
                {
                }

                /// <summary>X-coordinate of the origin.</summary>
                [FieldOffset(offsetof(kWindow32u, left))]
                k32u Left;

                /// <summary>Y-coordinate of the origin.</summary>
                [FieldOffset(offsetof(kWindow32u, top))]
                k32u Top;

                /// <summary>Width of the rectangle.</summary>
                [FieldOffset(offsetof(kWindow32u, width))]
                k32u Width;

                /// <summary>Height of the rectangle.</summary>
                [FieldOffset(offsetof(kWindow32u, height))]
                k32u Height;
            };
