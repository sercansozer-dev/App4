...
typedef struct kNetworkAdapterClass
{
    ...
    kBool isEnabled;                    //is the adapter able to send/receive packets?
    kBool isLinkRunning;                //is the adapter link (PHY) up or down?
    kNetworkAdapterType adapterType;    //adapter type.
...
//[Deprecated] 
kDeprecateEx kInlineFx(kStatus) kNetwork_LocalIpInterfaces(kArrayList entries)
{
