...
kFx(kStatus) kStream_CopyImpl(kStream stream, kStream source, k64u size, kCallbackFx progress, kPointer context, kSize bufferSize)
{
    ...
    kTry
    {
        ...
        {
            k64u bytesRemaining = size - bytesCopied; 
...
kFx(kStatus) kStream_CopyEx(kStream stream, kStream source, k64u size, kCallbackFx progress, kPointer context)
{
