...
#elif defined (K_STATIC)
#   define kFx(TYPE)    kInFx(TYPE)
#   define kDx(TYPE)    kInDx(TYPE)
#else
...
#define kERROR_OVERHEAT            (-975)      ///< System not fully functional due to overheat error.
 ...
 * @extends kValue
 * @ingroup kApi-Data
 * @brief   Window structure with 32-bit unsigned integer fields.
 *
 * kWindow32u supports the kdat6 serialization protocols.
 */
typedef struct kWindow32u
{
    k32u left;      ///< Horizontal origin.
    k32u top;       ///< Vertical origin.
    k32u width;     ///< Width of the ROI.
    k32u height;    ///< Height of the ROI.
} kWindow32u;
...
#define kPIXEL_FORMAT_VOID_TYPE_START           kPIXEL_FORMAT_MONO8                                 ///< First format that must used with kVoid pixel type
#define kPIXEL_FORMAT_MONO8                     (0x01080001)                                        ///< Monochrome 8-bit (PFNC.h)
#define kPIXEL_FORMAT_MONO12_PACKED             (0x010C0047)                                        ///< Monochrome 12-bit packed (PFNC.h)
/** @} */
...
#define kLOG_OPTION_TRACE           (0x4)    ///< Trace message.
#define kLOG_OPTION_DEBUG           (0x8)    ///< Debug message.
