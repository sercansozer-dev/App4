...
ifeq ($(OS)$(os), Windows_NT)
	...
	OS_SUFFIX := .exe
	PYTHON := python
	MKDIR_P := $(PYTHON) ../scripts/Utils/kUtil.py mkdir_p
	RM_F := $(PYTHON) ../scripts/Utils/kUtil.py rm_f
	RM_RF := $(PYTHON) ../scripts/Utils/kUtil.py rm_rf
	CP := $(PYTHON) ../scripts/Utils/kUtil.py cp
	KGENERATOR := $(PYTHON) ../scripts/Utils/kGenerator.py
else
...
KAPPGEN := $(PYTHON) ../scripts/Utils/kAppGen.py
...
ifeq ($(MAKECMDGOALS),)
ifeq ($(MAKE_RESTARTS),)
kApi-Linux_X64.mk: kApi.xml ../../Gocator/GoPxLSdk.xml ../scripts/Utils/Generator/GnuMk.py 
	$(info RegenX64 kApi-Linux_X64.mk)
	$(SILENT) $(KGENERATOR) --writers=GnuMk_Linux_X64 --platforms=Linux_X64 --project=kApi ../../Gocator/GoPxLSdk.xml
endif
endif
endif
