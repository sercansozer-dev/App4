...
namespace App4.Pages
{
    ...
    public sealed partial class Recipes_Page : Page
    {
        ...
        {
            System.Diagnostics.Debug.WriteLine(">>> [RECIPES] Sayfa Y�kleniyor...");
            ...
            try
            {
                ...
                catch (Exception ex) { System.Diagnostics.Debug.WriteLine("Re�ete y�kleme hatas�: " + ex.Message); }

                // 3. WEBVIEW2 BA�LATMA
                System.Diagnostics.Debug.WriteLine(">>> [RECIPES] WebView2 Haz�rlan�yor...");
                ...
                // B. Modeller Klasörü (Yazılabilir kullanıcı klasörü — MSIX install dir yerine)
                ...
                // HTML Dosyas�n� Olu�tur (Temp i�ine)
            ...
            {
                System.Diagnostics.Debug.WriteLine($"!!! [RECIPES KR�T�K HATA] : {ex.Message}");
            }
        }
    ...
    <script>
        ...
        function waitForTHREE(callback, attempt = 0) {{
            if (typeof THREE !== 'undefined' && 
                ...
                showError('THREE.js k�t�phaneleri y�klenemedi');
            }}
        }}
        ...
        function loadModel(url) {{
            ...
            loader.load(url, (gltf) => {{
                try {{
                    ...
                    // Klima �niteleri dike almak i�in (X ekseni etraf�nda 90 derece)
                ...
                try
                {
                    ...
                    if (pointData?.type == "NEW_POINT" && SelectedRecipe != null)
                    {
                        ...
                        var newPoint = new TargetPoint
                        {
                            ...
                            Description = "3D Edit�rden Se�ildi",
        ...
        private async void BtnSave_Click(object sender, RoutedEventArgs e)
        {
            ...
            await ShowMessage("Ba�ar�l�", $"{SelectedRecipe.RecipeName} kaydedildi.");
        }

        // --- K�T�PHANE VE DOSYA SE��M� ---
        ...
        // --- BUTTON HANDLERS (Bo� veya basit olanlar) ---
        ...
        private async void BtnBrowseFolder_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (files.Count > 0)
            {
                // Yazılabilir kullanıcı klasörü (MSIX install dir read-only olduğu için)
